...
class Ui_MainApp(object):
    def setupUi(self, MainApp):
        ...
        self.labelIzboTransmitera = QtWidgets.QLabel(self.layoutWidget)
        self.labelIzboTransmitera.setObjectName("labelIzboTransmitera")
        self.gridTransmiterIzbor.addWidget(self.labelIzboTransmitera, 0, 0, 1, 1)
        ...
        self.dijagramGraphicsWidget = QtWidgets.QGraphicsView(self.widget1)
        ...
        self.dijagramGraphicsWidget3 = QtWidgets.QGraphicsView(self.widget1)
        self.dijagramGraphicsWidget3.setObjectName("dijagramGraphicsWidget3")
        self.gridLayout.addWidget(self.dijagramGraphicsWidget3, 0, 1, 1, 1)
        self.dijagramGraphicsWidget2 = QtWidgets.QGraphicsView(self.widget1)
        self.dijagramGraphicsWidget2.setObjectName("dijagramGraphicsWidget2")
        self.gridLayout.addWidget(self.dijagramGraphicsWidget2, 0, 2, 1, 1)
        ...
        self.menuBazaPodataka = QtWidgets.QMenu(self.menubar)
        self.menuBazaPodataka.setObjectName("menuBazaPodataka")
        self.menuPodesavanja = QtWidgets.QMenu(self.menubar)
        ...
        self.menubar.addAction(self.menuBazaPodataka.menuAction())
        self.menubar.addAction(self.menuPodesavanja.menuAction())
        ...
        self.labelIzboTransmitera.setBuddy(self.listIzborTransmitera)
        self.labelIzborInterfejsa.setBuddy(self.comboBox)
    ...
    def retranslateUi(self, MainApp):
        ...
        self.labelIzboTransmitera.setText(_translate("MainApp", "Izbor povezanog transmitera:"))
        ...
        self.menuBazaPodataka.setTitle(_translate("MainApp", "Baza podataka"))
        self.menuPodesavanja.setTitle(_translate("MainApp", "Podešavanja"))
